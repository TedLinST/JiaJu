// 综合服务数据助手
export const DataIntegratedServicesHandler = {

  // 展会服务
  ES: {
    title: '展会服务',
    enTitle: 'EXHIBITION SERVICE',
    menuData: [
      { title: '国内展会' },
      { title: '国外展会' },
      { title: '专门性展会' }
    ...
    data3: [
      ...
      {
        id: '3',
        title: '荣耀降临：是谁摘得了第五届GOtrend金汐奖的桂冠 ？',
        time: '2019-05-22'
      },
      {
        id: '4',
        title: '第一届 “中法设计之约”将于3月19-23日在深圳举办',
        time: '2019-05-22'
      },
      {
        id: '5',
        title: '深圳时尚家居设计周，中国与世界预见未来的世纪之约',
        time: '2019-05-22'
      },
      {
        id: '6',
        title: '创新、实用和美观之间 | 瑞士设计智慧再现',
        time: '2019-05-22'
      },
      {
        id: '7',
        title: 'CIFF Guangzhou 精彩提前看 | 让你的创想领先一整年的设计盛会',
        time: '2019-05-22'
      },
      {
        id: '8',
  ...
  LS: {
    title: '物流售后服务',
    enTitle: 'LOGISTICS SERVICE',
    data: [
      {
        id: 1,
        title: '服务介绍',
        enTitle: 'Service Introduction',
        src: 'assets/imgs/integrated-services/shouhou-1.jpg'
      },
      {
        id: 2,
        title: '我要下单',
        enTitle: 'I want to place an order',
        src: 'assets/imgs/integrated-services/shouhou-2.jpg'
      },
      {
        id: 3,
        title: '师傅加入',
        enTitle: 'Master joined',
        src: 'assets/imgs/integrated-services/shouhou-3.jpg'
      },
      {
        id: 4,
        title: '商家接入',
        enTitle: 'Merchant access',
        src: 'assets/imgs/integrated-services/shouhou-4.jpg'
      },
      {
        id: 5,
        title: '服务查询',
        enTitle: 'Service inquiry',
        src: 'assets/imgs/integrated-services/shouhou-5.jpg'
      },
