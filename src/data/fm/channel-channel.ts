// 家具商城 - 众筹频道数据助手
export const DataChannelChannelHandler = {
  // 众筹类目
  CRC: {
    title: '众筹类目',
    enTitle: 'CROWD RAISING CATEGORY',
    menuData: [
      { title: '原创设计' },
      { title: '智能家居' },
      { title: '学生作品' },
  ...
  CC: {
    ...
    data: [
      ...
      {
        ChanPinBiaoTi: '东家家具榫卯结构黑胡桃全实木儿童凳',
        ChanPinPinLei: '儿童家具',
        ChanPinJiaGe: 188,
