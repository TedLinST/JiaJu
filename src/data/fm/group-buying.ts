...
export const DataGroupBuyingHandler = {
  ...
  LIST_DATA: [
    {
      ChanPinBiaoTi: '林氏木业北欧简约现代沙发床小户型布艺沙发三人客厅',
      ChanPinPinLei: '沙发',
      PinPai: '林氏木业',
      DianPu: '林氏木业家具旗舰店',
      ChanDi: '广东佛山',
    ...
    {
      ChanPinBiaoTi: '林氏木业北欧皮艺沙发组合客厅头层牛皮质现代真皮沙发整装RBE1K',
      ChanPinPinLei: '沙发',
      PinPai: '林氏木业',
      DianPu: '林氏木业家具旗舰店',
      ChanDi: '广东佛山',
    ...
    {
      ChanPinBiaoTi: '林氏木业现代简约客厅布艺沙发组合时尚小户型北欧家具套装',
      ChanPinPinLei: '沙发',
      PinPai: '林氏木业',
      DianPu: '林氏木业家具旗舰店',
      ChanDi: '广东佛山',
    ...
    {
      ChanPinBiaoTi: '林氏木业真皮沙发小户型客厅三人奢华头层牛皮欧式沙发组合',
      ChanPinPinLei: '沙发',
      PinPai: '林氏木业',
      DianPu: '林氏木业家具旗舰店',
      ChanDi: '广东佛山',
