// 原辅材料机械设备服务数据助手
export const DataMaterialEquipmentHandler = {

  // 原辅材料商城
  MM: {
    title: '原辅材料商城',
    enTitle: 'ORIGINAL AUXILIARY MATERIALS MALL',
    data: [
      {
        id: 1,
        title: '天然木材',
  ...
  MS: {
    title: '原辅材料团购',
    enTitle: 'PURCHASE OF RAW AND AUXILIARY MATERIALS',
    data: [
      {
        id: 1,
        title: '天然木材',
  ...
  MP: {
    title: '原辅材料求购',
    enTitle: 'RAW AND AUXILIARY MATERIALS PURCHASE',
    data: [
      {
        id: 1,
        data: [
  ...
  MSU: {
    title: '原辅材料供应商',
    enTitle: 'RAW AND AUXILIARY MATERIALS SUPPLIER',
    data: [
      {
        id: 1,
        title: '天然木材',
  ...
  ES: {
    title: '机械设备供应商',
    enTitle: 'MACHINERY EQUIPMENT SUPPLIER',
    data: [
      {
        id: 1,
        data: [
  ...
  EP: {
    title: '机械设备求购',
    enTitle: 'MACHINERY AND EQUIPMENT PURCHASE',
    data: [
      {
        id: 1,
        title: '自动双端开榫机',
