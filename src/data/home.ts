...
export const DataHomeHandler = {
  ...
  ER: {
    title: '企业资源管理系统',
    enTitle: 'ENTERPRISE RESOURCE MANAGEMENT SYSTEM',
    menuData: [
      { title: '组织管理' },
      { title: '销售管理' },
      { title: '开发管理' },
    ...
    data: [
      { id: 1, src: 'assets/imgs/home/qiYeZiYuanGuanLiXiTong/zuZhi.jpg' },
      { id: 2, src: 'assets/imgs/home/qiYeZiYuanGuanLiXiTong/xiaoShou.jpg' },
      { id: 3, src: 'assets/imgs/home/qiYeZiYuanGuanLiXiTong/kaiFa.jpg' },
      { id: 4, src: 'assets/imgs/home/qiYeZiYuanGuanLiXiTong/shengChan.jpg' }
    ]
  },
  ...
  PD: {
    title: '产品设计开发服务',
    enTitle: 'PRODUCT DESIGN AND DEVELOPMENT SERVICES',
    menuData: [
      { title: '大数据分析' },
      { title: '产品设计资料库' },
      { title: '设计师园地' },
  ...
  SEC: {
    title: '校企合作服务',
    enTitle: 'SCHOOL-ENTERPRISE COOPERATION SERVICE',
    menuData: [
      { title: '学校项目' },
      { title: '企业需求' },
      { title: '互动讲堂' },
