export const PortalRoutes = [
    ...
    /* 企业资源管理系统系统模块 */
    { path: 'er-login', loadChildren: '../project/er/er-login/er-login.module#ErLoginModule' }, // 企业资源管理系统登录
    { path: 'er', loadChildren: '../project/er/enterprise-resource/enterprise-resource.module#EnterpriseResourceModule' }, // 企业资源管理系统
    ...
    { path: 'business-service', loadChildren: '../project/is/business-service/business-service.module#BusinessServiceModule' }, // 工商服务
