...
@Component({
  selector: 'app-furniture-standard',
  templateUrl: './furniture-standard.component.html',
  styleUrls: ['./furniture-standard.component.scss']
})
export class FurnitureStandardComponent implements OnInit {
