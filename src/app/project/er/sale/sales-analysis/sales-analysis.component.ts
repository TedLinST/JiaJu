...
import { DataSaleSalesAnalysisHandler } from 'src/data/er/sale/sales-analysis';
...
export class SalesAnalysisComponent extends UtilsTableMarkForCheck implements OnInit {
  ...
  ngOnInit() {
    this.dataHandler = DataSaleSalesAnalysisHandler;
