...
import { DataProdProductionPlanningControlHandler } from 'src/data/er/prod/production-planning-control';
import { Utils } from 'src/modules/utils/utils';
import { IdCounter } from 'src/modules/utils/id-counter';

@Component({
  selector: 'app-production-planning-control',
  templateUrl: './production-planning-control.component.html',
  styleUrls: ['./production-planning-control.component.scss']
})
export class ProductionPlanningControlComponent extends UtilsTableMarkForCheck implements OnInit {
  ...
  ngOnInit() {
    this.dataHandler = DataProdProductionPlanningControlHandler;
