...
import { DataProdMaterialConsumptionAnalysisHandler } from 'src/data/er/prod/material-consumption-analysis';
import { Utils } from 'src/modules/utils/utils';
import { IdCounter } from 'src/modules/utils/id-counter';

@Component({
  selector: 'app-material-consumption-analysis',
  templateUrl: './material-consumption-analysis.component.html',
  styleUrls: ['./material-consumption-analysis.component.scss']
})
export class MaterialConsumptionAnalysisComponent extends UtilsTableMarkForCheck implements OnInit {
  ...
  ngOnInit() {
    this.dataHandler = DataProdMaterialConsumptionAnalysisHandler;
