...
import { DataProdProcessHoursWagesHandler } from 'src/data/er/prod/process-hours-wages';
import { Utils } from 'src/modules/utils/utils';
import { IdCounter } from 'src/modules/utils/id-counter';

@Component({
  selector: 'app-process-hours-wages',
  templateUrl: './process-hours-wages.component.html',
  styleUrls: ['./process-hours-wages.component.scss']
})
export class ProcessHoursWagesComponent extends UtilsTableMarkForCheck implements OnInit {
  ...
  ngOnInit() {
    this.dataHandler = DataProdProcessHoursWagesHandler;
